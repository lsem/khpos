...
describe("[serialize", () => {
  it("/generic serialize]", () => {
    const example: Example = {
      id1 : EID.makeRawPOSID("be684f10-a35d-11ea-bb37-0242ac130002"),
      s : 'I am example',
      b : true,
      id2 : EID.makeRawGoodID("be684f10-a35d-11ea-bb37-0242ac130002")
    };
  ...
  it("/GoodModel]", () => {
    const sample: GoodModel = {
      id : EID.makeRawGoodID("be684f10-a35d-11ea-bb37-0242ac130002"),
      name : 'Шарлотка',
      units : 'шт',
      available : true,
      removed : false
